...
require_once('../../sippc2016f/Connections/enlace.php');
require_once('../../model/class.medoogn.php');
$cn = new consumomedoo($cnmsippc2016);
...
if(isset($_FILES['upl']) && $_FILES['upl']['error'] == 0){
	...
	$nombre = '../../sippc2016f/UPLOADS/'.$info['basename'].".txt";
	...
	$destino = '../../sippc2016f/UPLOADS/'.$archivo.".".$extensionf;
