...
(function($){
	function buildGrid(target){
		...
		$(target).datagrid($.extend({}, opts, {
			onDblClickCell:function(index,field){
				...
				if (opts.editing){
					...
					focusEditor(field);// add para el tamaño al editar
					...
					// carga de mensaje cuando se este cargando 
					
					$.messager.progress({title:'Cargando Sistema SIPPC relacionada',msg:'Espere por favor'});
					// para el timepo de espera 
		...
		// en q campo se da click  en el field
