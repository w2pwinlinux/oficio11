...
<HTML>
  ...
  <BODY >
    ...
    <input type="hidden" name="input_title" id="input_title" value="REPORTE CATEGORIA">
        ...
        <table id="dg_PASO1" class="easyui-datagrid dg_PASO1" title="--"
          ...
          <thead>
            <tr>
              ...
              <th field="NOMBRE" width="40%" >Nombres</th>
